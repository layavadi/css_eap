...
if __name__ == "__main__":
    ...
    embedding_connector_id = client.register_connector(Config.CSS_CONNECTOR_NAME_EMBEDDING, Config.CONNECTOR_FOR_EMBEDDING_BODY)

    #register the Embedding model 
    client.register_embedding_model(embedding_connector_id)
